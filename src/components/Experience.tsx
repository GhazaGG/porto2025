...
const Experience: React.FC = () => {
  const experiences: WorkExperience[] = [
    {
      id: 1,
      company: 'AI Network Solutions ',
      position: 'Full Stack Developer',
      duration: 'Jun 2025 - Present',
      location: 'Purwokerto, Indonesia',
      description: 'Developed automation tools and web applications to enhance AI model deployment. Improved system performance by 40% through optimization techniques.',
      technologies: ['React', 'Node.js', 'TypeScript', 'AWS', 'Docker', 'PostgreSQL'],
      companyUrl: 'https://ainetworksolutions.com',
      logo: '🏢',
      type: 'full-time'
    },
    {
      ...
      location: 'Remote',
      description: 'Developed cloud-native applications using modern frameworks. Collaborated with cross-functional teams to deliver high-quality software solutions. Enhanced CI/CD pipelines, reducing deployment time by 30%.',
      technologies: ['Google Cloud Platform', 'Kubernetes', 'Terraform', 'Python', 'Flask'],
    ...
    },
    {
      ...
      location: 'Remote',
      description: 'Built multiple web applications for startups and small businesses. Implemented payment gateways and user authentication systems. Achieved 95% client satisfaction rate through effective communication and timely delivery.',
